...
module.exports = {
	...
	// Project options.
	projectURL: 'localhost:8888/lcc', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	watchJsCustom: './js/src/*.js', // Path to all custom JS files.
	watchPhp: './**/*.php', // Path to all PHP files.

	// Translation options.
	textDomain: 'lcc', // Your textdomain here.
	translationFile: 'lcc.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'LCC', // Package name.
